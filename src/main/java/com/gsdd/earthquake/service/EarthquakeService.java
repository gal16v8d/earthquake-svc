...
public class EarthquakeService {
  ...
  public EarthquakeResponse earthquakeQuery(EarthquakeRequest request) throws Exception {
    ...
    return restTemplate
        .exchange(URL_USGS_QUERY, HttpMethod.GET, entity, EarthquakeResponse.class, params)
        .getBody();
  }
  ...
  public EarthquakeCount earthquakeCountQuery(EarthquakeRequest request) throws Exception {
    ...
    return restTemplate
        .exchange(URL_USGS_COUNT, HttpMethod.GET, entity, EarthquakeCount.class, params).getBody();
  }
  ...
  private Map<String, Object> defineQueryParams(String startTime, String endTime,
      double minMagnitude) {
